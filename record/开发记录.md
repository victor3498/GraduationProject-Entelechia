...
## 2026/2/4
    最近一次打开功能完成，连带文档功能测试完成

    | 方法   | 路径                                 | 说明         |
| ---- | ---------------------------------- | ---------- |
| GET  | `/api/user-preference/last-opened` | 获取上一次打开的文档 |
| POST | `/api/user-preference/last-opened` | 记录本次打开的文档  |
...
2026/3/13
3月初归校之后开始开发前端，计划先完成pc端再基于pc端完成移动端，目前基本小组件编写中
